...
import mittvaja.com.nomnom.Adapters.ReviewFragmentListAdapter;
...
import mittvaja.com.nomnom.Interfaces.IRetrofitDataApi;
import mittvaja.com.nomnom.Models.APIClient;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mVendorBookmarkButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String foundPlace = NomNom.database.iDoa().checkInDatabase(id);
                ...
                if (name.equalsIgnoreCase(foundPlace)) {
                    ...
                    NomNom.database.iDoa().addPlace(placeBookmark);
